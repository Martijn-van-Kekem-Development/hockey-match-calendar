...
export class ICS {
    ...
    public static calendarToICS(title: string, path: string, matches: Match[]): string {
        ...
        content.push(`DESCRIPTION:Generated by https://hockeycal.vankekem.com`);
        content.push(`X-ALT-DESC;FMTTYPE=text/html:<a href="https://hockeycal.vankekem.com">Hockey Match Calendar</a>`);
        content.push(`X-WR-CALDESC:Generated by https://hockeycal.vankekem.com`);
