...
describe("DateHelper tests", () => {
    describe("Convert TMS date", () => {
        test("From Vancouver to UTC", () => {
            const output = DateHelper.TMStoUTC(
    ...
    test("From UTC to ICS", () => {
        const output = DateHelper.toICS(DateHelper.TMStoUTC(
            "8 Aug 2024 18:08", "America/Vancouver"));
    ...
    describe("Convert KNHB date", () => {
        test("To UTC", () => {
            const output =
                DateHelper.KNHBtoUTC("2024-09-15T12:45:00.000000Z");
        ...
        test("To local", () => {
            const output =
                DateHelper.KNHBtoLocal("2024-09-15T12:45:00.000000Z");
